...
export default function EStoreFilterLeft({
  priceRange,
  setPriceRange,
  selectedRatings,
  handleRatingChange,
  ...
  return (
    <div className="bg-gray-50 p-4 rounded-lg">
      <h2 className="font-semibold text-lg mb-4">E-Store Filters</h2>
        ...
        <div className="space-y-2">
          {["Brand A", "Brand B", "Brand C", "Brand D"].map((brand) => (
            <div key={brand} className="flex items-center justify-between">
              ...
              <span className="text-xs text-muted-foreground">{brand === "Brand A" ? 50 : brand === "Brand B" ? 30 : 10}</span>
            </div>
          ))}
        </div>
      </div> */}
