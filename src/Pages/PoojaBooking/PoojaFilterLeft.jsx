...
export default function PoojaFilterLeft() {
  // State management
  ...
  const applyFilters = () => {
    console.log("Applying Filters:", { priceRange, selectedRatings, productStatus, selectedBrands });
  };

  return (
    <div className="bg-gray-50 p-4 rounded-lg">
      <h2 className="font-semibold text-lg mb-4">Pooja Product Filters</h2>
  ...
  return (
    <div className="bg-gray-50 p-4 rounded-lg">
      <div className="border-t pt-4 mb-6">
        ...
        <button className="w-full bg-red-600 hover:bg-red-700 text-white p-2" onClick={applyFilters}>
          APPLY
        </button>
      </div>
