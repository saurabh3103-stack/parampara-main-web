...
const Cart = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      if (error) {
        ...
        setItems(cart); // Set the fetched cart data into state
      }
    } catch (error) {
      console.error("Error:", error);
      setError("Failed to fetch cart data");
  ...
  const subtotal = items.reduce((total, item) => total + item.product_amount * item.quantity, 0);
                    ...
                    <div className="p-4 md:p-6">
                      <div className="flex flex-col md:flex-row gap-6">
                        <div className="relative h-32 w-32 mx-auto md:mx-0 rounded-lg overflow-hidden border-2 border-orange-200 bg-white">
                          <img
                            src={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTGdMDcrPDTOCYmO4HSUFD_8XxZpv7fVJPQszto_K87ZIC8sdjiVTnmWZS9-MjXR4Wh0ErK&s"}
                            // src={imgUrl + item.product_image || "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTGdMDcrPDTOCYmO4HSUFD_8XxZpv7fVJPQszto_K87ZIC8sdjiVTnmWZS9-MjXR4Wh0ErK&s"}
