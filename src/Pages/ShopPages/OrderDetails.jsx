...
const OrderDetails = ({ previewData ,deliveryAddress }) => {
    return (
        <>
                        ...
                        <div className="w-full space-y-6">
                            <div class="flex w-full flex-col items-center space-y-1 sm:flex-row sm:flex-nowrap sm:space-y-0">
                                ...
                                <div class="w-full rounded bg-gray-100 sm:w-2/3">
                                    <input class="focus:border-primary-500 focus:ring-primary-500 block w-full rounded border-transparent bg-gray-100 p-2.5 text-sm text-gray-900" type="text"  value={previewData.userDetails.username} disabled/>
                                </div>
                            </div>
                            <div class="flex w-full flex-col items-center space-y-1 sm:flex-row sm:flex-nowrap sm:space-y-0">
                                <div class="w-full sm:w-1/3">Email <span class="text-red-500">*</span></div>
                                <div class="w-full rounded bg-gray-100 sm:w-2/3">
                                    <input class="focus:border-primary-500 focus:ring-primary-500 block w-full rounded border-transparent bg-gray-100 p-2.5 text-sm text-gray-900" type="text"  value={previewData.userDetails.email} disabled/>
                                </div>
                            </div>
                            <div class="flex w-full flex-col items-center space-y-1 sm:flex-row sm:flex-nowrap sm:space-y-0">
                                <div class="w-full sm:w-1/3">Contact Number <span class="text-red-500">*</span></div>
                                <div class="w-full rounded bg-gray-100 sm:w-2/3">
                                    <input class="focus:border-primary-500 focus:ring-primary-500 block w-full rounded border-transparent bg-gray-100 p-2.5 text-sm text-gray-900" type="text"  value={previewData.userDetails.contactNumber} disabled/>
                                </div>
                            </div>
                            <div class="flex w-full flex-col items-center space-y-1 sm:flex-row sm:flex-nowrap sm:space-y-0">
