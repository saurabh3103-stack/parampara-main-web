...
const OrderPreview = () => {
    ...
    const fetchData = async () => {
        try {
            ...
            const [orderResponse, addressResponse] = await Promise.all([
                fetch(`http://192.168.1.39:3000/api/orders/${id}`, {
                    method: "GET",
                    headers: {
                ...
                fetch(`http://192.168.1.39:3000/api/order/delivery-address/${id}`, {
                    method: "GET",
                    headers: {
                        "Content-Type": "application/json",
                        Authorization: `Bearer ${token}`,
    ...
    if(orderType === "Bhajan Mandali"){
        const fetchMadali = async (orderData = {}) => {
            try {
                ...
                const mandaliResponse = await fetch(`http://192.168.1.39:3000/api/bhajanMandal/single_bhajan/${id}`, {
                    method: "GET",
                    headers: {
                        "Content-Type": "application/json",
                        Authorization: `Bearer ${token}`,
    ...
    const handleConfirmOrder = async () => {
        ...
        try {
            ...
            let orderDetails;
            if (orderType === "Pooja") {
                updateUrl = "http://192.168.1.39:3000/api/orders/update-order";
                orderDetails = {
                    bookingId: id,
                ...
                updateUrl = "http://192.168.1.39:3000/api/order/update-mandali-order";
                orderDetails = {
                    bookingId: id,
